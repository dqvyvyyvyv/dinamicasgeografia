...
function goToBasicCheckout() {
    window.location.href = "https://www.ggcheckout.com/checkout/v5/aTGeqcu1WLJLPr6pJYjg";
}

// Funções do Pop-up de Upgrade (Novo)
...
function addPlanButtonEffects() {
    ...
    planButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            // Se for o botão de 10 reais (Plano Básico), mostra o upgrade primeiro
